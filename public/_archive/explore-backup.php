...
<body>
    <nav class="navbar">
        <div class="nav-container">
            <a href="index.php" class="nav-brand"><img src="logo-192x192.png" alt="Culture Radar Logo" style="width: 30px; height: 30px; vertical-align: middle; margin-right: 8px;" loading="lazy">CultureRadar</a>
            <div class="nav-menu">
